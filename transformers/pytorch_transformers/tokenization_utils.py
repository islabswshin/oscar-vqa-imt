...
class PreTrainedTokenizer(object):
    ...
    @property
    def imt_token(self):
        if self._imt_token is None:
            logger.error("Using imt_token, but it is not set yet.")
        return self._imt_token
    ...
    @imt_token.setter
    def imt_token(self, value):
        self._imt_token = value

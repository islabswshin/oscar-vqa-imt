...
parser.add_argument(
    "-d", "--data-root", default="C:/Users/DH/codes/virtex/datasets/coco",
    help="Path to the root directory of COCO dataset.",
)
parser.add_argument(
    "-s", "--split", choices=["train", "val"], default="train",
...
if __name__ == "__main__":
    ...
    map_size = 1099511627776 * 2 if platform.system() == "Linux" else 40000000
    db = lmdb.open(
